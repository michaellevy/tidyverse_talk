...
We have seen that we can use map_lgl to ensure we get a logical vector, map_chr to ensure we get a character vector back, etc. Here are two more type-stable function implemented in `purrr`.
